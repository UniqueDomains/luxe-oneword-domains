...
- `luxe.csv` — public CSV extract (9,687 rows)
- `luxe.json` — public JSON extract (9,687 rows)
...
> Unique Domains. *Available .LUXE One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
